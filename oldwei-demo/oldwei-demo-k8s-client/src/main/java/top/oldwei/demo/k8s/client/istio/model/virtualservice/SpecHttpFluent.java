...
public interface SpecHttpFluent<A extends SpecHttpFluent<A>> extends Fluent<A> {
    ...
    Boolean hasRewrite();
    SpecHttpRewriteNested<A> withNewRewrite();
    SpecHttpRewriteNested<A> withNewRewriteLike(SpecHttpRewrite item);
    SpecHttpRewriteNested<A> editRewrite();
    SpecHttpRewriteNested<A> editOrNewRewrite();
    SpecHttpRewriteNested<A> editOrNewRewriteLike(SpecHttpRewrite item);
    ...
    Boolean hasMirror();
    SpecHttpMirrorNested<A> withNewMirror();
    SpecHttpMirrorNested<A> withNewMirrorLike(SpecHttpMirror item);
    SpecHttpMirrorNested<A> editMirror();
    SpecHttpMirrorNested<A> editOrNewMirror();
    SpecHttpMirrorNested<A> editOrNewMirrorLike(SpecHttpMirror item);
    ...
    public interface SpecHttpMatchNested<N> extends io.fabric8.kubernetes.api.builder.Nested<N>, SpecHttpMatchFluent<SpecHttpMatchNested<N>> {
        public N and();    public N endMatch();
    }

    public interface SpecHttpRewriteNested<N> extends io.fabric8.kubernetes.api.builder.Nested<N>, SpecHttpRewriteFluent<SpecHttpRewriteNested<N>> {
        public N and();    public N endRewrite();
    }

    public interface SpecHttpRetriesNested<N> extends io.fabric8.kubernetes.api.builder.Nested<N>, SpecHttpRetriesFluent<SpecHttpRetriesNested<N>> {
        public N and();    public N endRetries();
    }

    public interface SpecHttpMirrorNested<N> extends io.fabric8.kubernetes.api.builder.Nested<N>, SpecHttpMirrorFluent<SpecHttpMirrorNested<N>> {
